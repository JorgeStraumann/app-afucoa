-- AFUCOA V2 — Storage privado y registro seguro de adjuntos
-- Incremento 08. Ejecutar después de schema-v2.sql y security-v2.sql.
...
-- Adjuntos de trámites: el primer segmento del path debe ser el UUID del expediente.
...
-- PDFs institucionales: privados en Storage; lectura autorizada por documento publicado o administración.
...
-- Recursos editoriales explícitamente públicos.
